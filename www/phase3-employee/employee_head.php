        ...
        <div class="row">
            <div class="col-md-2 chief-page_left col-sm-0 left-side">
                ...
                <div class="chief-page_left-navbar_item left-side_item" id="update-info">
                    ...
                    <a href="http://localhost:8080/phase3-employee/employee_update-info.php" class="text-white chief-page_left-title left-side_title" >Update Info</a>
                </div>

                <div class="chief-page_left-navbar_item left-side_item mt-2" id="tasks-management">
                    <i class="fas fa-briefcase text-white"></i>
                    <a href="http://localhost:8080/phase3-employee/employee_task.php" class="text-white chief-page_left-title left-side_title" >Assigned Tasks</a>
                </div>

                <div class="chief-page_left-navbar_item left-side_item mt-3" id="attendence">
                    <i class="fas fa-calendar-week text-white"></i>
                    <a href="http://localhost:8080/phase3-employee/employee_attendence.php" class="text-white chief-page_left-title left-side_title" >Attendence</a>
                </div>
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                          <a class="dropdown-item" href="#" id="update-info">
                            <a href="http://localhost:8080/phase3-employee/employee_update-info.php" class=" chief-page_left-title left-side_title" >Update Info</a>
                          </a>
                          <a class="dropdown-item" href="#" id="tasks-management">
                            <a href="http://localhost:8080/phase3-employee/employee_task.php" class=" chief-page_left-title left-side_title" >Assigned Tasks</a>
                          </a>
                          <a class="dropdown-item" href="#" id="attendence">
                            <a href="http://localhost:8080/phase3-employee/employee_attendence.php" class=" chief-page_left-title left-side_title" >Attendence</a>
                          </a>
